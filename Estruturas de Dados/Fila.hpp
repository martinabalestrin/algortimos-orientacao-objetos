...
class Fila {
	...
	public:
		...
		int find_ReturnId(T x); // Verifica se um elemento está na fila e retorna o índice, ou -1 se não estiver
		void pop_ByElement(T x); // Remove um elemento específico da fila
